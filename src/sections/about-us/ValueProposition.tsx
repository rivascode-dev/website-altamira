      ...
      <div className='container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl'>
        <div className='text-center mb-16 max-w-3xl mx-auto'>
          ...
          <p className='text-lg md:text-xl text-muted-foreground leading-relaxed font-normal'>
            Operamos bajo el concepto de &quot;Prevención hoy, tranquilidad
            mañana&quot;. Entendemos que el mantenimiento no es un gasto, sino
            una inversión obligatoria para evitar colapsos sanitarios y multas
            legales.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8'>
          {VALUE_PROPS.map((prop, index) => (
            <div key={index} className='flex flex-col'>
              ...
              >
                <div
                  className={`p-4 rounded-2xl mb-6 ${prop.colorClass} ${prop.bgClass}`}
                >
                  {prop.icon}
                </div>
