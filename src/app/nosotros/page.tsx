...
export const metadata: Metadata = {
  ...
  description:
    'Conoce a Altamira Ductos, expertos en limpieza, mantención y sanitización de sistemas de ductos en edificios y condominios. Socio estratégico para comunidades saludables.',
  alternates: {
    canonical: '/nosotros',
  },
};
